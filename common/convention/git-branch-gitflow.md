...
이 문서는 실제 프로젝트 Git 저장소에 기본 적용하는 GitFlow 브랜치 생성 및 관리 규칙을 정의한다.

## Scope

- 기본 적용 대상은 registry가 가리키는 실제 프로젝트 Git 저장소다.
- 하네스 저장소 자체의 브랜치 전략은 `workspace-git-governance.md`를 따른다.
- 프로젝트 전용 Git 규칙 문서가 있으면 그 문서를 우선한다.
...
- 하네스 저장소 자체에는 이 문서를 기본 적용하지 않는다.
